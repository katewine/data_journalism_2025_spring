...
* **Question**: How did voting behavior differ between precincts based on economic status in 2020 and 2024? 
...
* **Analysis summary**: In order to analyze voting behavior by precinct based on race both years, I found a premade racial data set per precinct based on the 2020 census. Using this, I assigned racial majorities to precincts and grouped by race and winner to compare by winner and year.
...
```{r}
#assign racial majority to precincts based on Maryland Planning Board data based on 2020 census:  https://planning.maryland.gov/Redistricting/Pages/2020/precinct.aspx
...
#add racial data to 2020 precinct election data
  ...
  racial_analysis2020 <- election_population_2020|>
    ...
    select(winner,race,precincts,precinct_pct)
#run analysis
  racial_analysis2020
