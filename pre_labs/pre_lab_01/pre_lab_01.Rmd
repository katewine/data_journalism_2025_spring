...
**Answer: This code groups the data by combining each contribution that happened on the same date and added them together to count how many contributions happened on each day**
...
**Answer: This code arranges the data by putting the day with the most contributions at the top and least at the bottom.**
