...
**Task** In the console (look below), type 2+2 and hit enter. What does it return? Type your answer below. **Answer:2**
...
**Answer: This code groups the data by data, combining each contribution by date and adds each of them up to count how many contributions happened on one day**
...
**Answer: On top of the previous example, this code arranges the data by putting the day with the most contributions at the top and least at the bottom.**
...
**This groups by which campaign was donated to, how much and how often**
...
**This accounted for different spellings of each campaign, consolidating count and amount into one campaign each even if they werent written the same**
...
**This code added mean and median breakdowns of each campaign's contributions.  TRUMP NATIONAL COMMITTEE JFC, INC.  was the top **
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **This is sorted by city with the highest total amount of donations, not by campaign**
