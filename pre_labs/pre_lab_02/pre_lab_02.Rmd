...
**Answer: The code is creating a new column that is the percentage of votes candidates received on election day over total votes**
...
**Answer: These results are now arranged from greatest percent of votes received on voting day to the lowest percent because we added the arrange(desc) function.**
...
**Answer: This is more interesting because it is expected that most votes would occur on election day, but some candidates received no votes on election day while still receiving some votes in through other means.  **
...
**Answer: The mutate statement is creating a new column that categorizes each donation into different ranges **
...
**Answer: This is important so that you can easily bring up all of the other non-selected data without having to undo your code later in case there are other pieces of data that you are interested in that you havent selected for**
...
**Answer:The expenditure date is now formatted as Year, Month, Day**
...
**Answer: All of the expenditures per month**
