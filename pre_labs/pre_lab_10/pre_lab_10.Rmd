...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer**  PRECINCT_ID  PRECINCT_NAME CONGRESS LEGIS COUNCIL SCHOOL POLLING_ID Shape_Length  Shape_Area Shape   
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** It includes data about each type of district and geospatial data like how long, how big and how the precinct is shaped.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is Prince Georges county split up by precincts
...
**Task** Run the following code. Describe the output in the space below. **Answer** It downloaded Tigris, and loaded the library
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code created a dataframe of county information, including geospatial data
...
**Task** Run the following code. Describe the output in the space below. **Answer** This creates a dataframe of only Maryland County geospatial data
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a map of Maryland counties
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code shows the two dataframes for PG County and PG County precincts layers on top of one another
...
**Task** Run the following code. Describe the output in the space below. **Answer** This shows voter turnout per precinct in PG County
...
**Task** Run the following code. Describe the output in the space below. **Answer** This creates a dataframe of precinct voter turnout data with the geospatial data of each precinct
...
**Task** Run the following code. Describe the output in the space below. **Answer** This creates a map visualizing eligible voters per precinct in PG county
...
**Task** Run the following code. Describe the output in the space below. **Answer** This creates a dataframe that arranges counties by which have the most eligible voters
...
**Task** Run the following code. Describe the output in the space below. **Answer** This creates a dataframe of tota population per county in Maryland
...
**Task** Run the following code. Describe the output in the space below. **Answer** This creates the same dataframe as before only adds in automatically the geospatial data of each county as well
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code runs both dataframes, showing the difference between column names for county  
...
**Task** Run the following code. Describe the output in the space below. **Answer** This renames the column names to make them joinable
...
**Task** Run the following code. Describe the output in the space below. **Answer** This joins the two dataframes
...
**Task** Run the following code. Describe the output in the space below. **Answer** This renames St. Mary's and Baltimore county
...
**Task** Run the following code. Describe the output in the space below. **Answer** This calculates the number of voters per capita from highest to lowest
...
**Task** Run the following code. Describe the output in the space below. **Answer** This creates a map of Maryland counties based on its number of voters per capita
...
**Task** Run the following code. Describe the output in the space below. **Answer** This changes the color theme to magma
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** This changes the color scale to make it more readable. 3 counties on the Eastern Shore have much higher rate of eligible voters per capita than the counties surrounding DC
...
**Task** Run the following code. Describe the output in the space below. **Answer** This creates the number of unaffiliated voters per capita per county
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see, especially on the ends of the scale? **Answer** Prince Georges county and Montgomery county have a lower number of unaffiliated voters per capita than central  Maryland
