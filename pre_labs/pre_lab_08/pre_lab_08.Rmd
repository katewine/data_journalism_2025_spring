...
**Answer** The code loads md_voters, and overwriters the original dataframe.
It creates a new column called UNAF_DIFF that shows the difference between the number of Unaffiliated registrants between 2024 and 2022.

Then the load loads a new dataframe,based on md_voters that arranges UNAF_DIFF from greatest to least, selecting only for County and the UNAF_DIFF.
Then it shows the first 10 rows: the top ten counties.
```{r}
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a blank, white page
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now, I see a bar chart, comparing the top ten counties from the dataframe
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Now the counties are ordered by count from least to greatest, left to right
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Now the chart has been flipped to show horizontal bars instead of vertical bars, with the greatest on top and the smallest below
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The background is no longer grey.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** The whole background has a blue tint to it.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The chart has a title, the axes have more descriptive names, and there is a citation for the source
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** There is a dataframe showing how many contributions were given on a certain day
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** There is a chart that illustrates how many contributions happened between april and july
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The chart now has delineations of weeks as time progresses,instead of months. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The data labels have been turned to make them more legible.
