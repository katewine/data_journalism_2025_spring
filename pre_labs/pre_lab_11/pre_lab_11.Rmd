...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer**The columns seem to have the correct data in good formatting, but the names are very long.
...
**Task** Run the following code to extract the table we want, clean up the names and remove the total row. Look at the rename() function - what do you think the numbers 2 through 6 are referring to? **Answer** The numbers refer to the columns.
...
**Task** Run the following code in the gray-colored codeblock below to find the <li> tags. What does the output suggest about how many <ul> tags there are in the HTML source? **Answer** I don't think it suggests there are any <ul> tags in this HTML source
...
**Task** Run the following code in the gray-colored codeblock below to find the text inside <li> tags. Describe the output: **Answer** The output now only shows non-code text. For example   <a href="/representatives" data-drupal-link-system-path="represen... becomes Representatives. 
...
### Task 11: Turn the contents of the <li> and <a> tags into a dataframe **Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** This code creates a dataframe with two columns: committeees and URLS of said committee, but the URLS seem wrong.
